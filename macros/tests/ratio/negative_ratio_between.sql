{% test negative_ratio_between(model, column_name, min_ratio, max_ratio, group_by=None, where=None) %}
...
where
    {{ dbt_checks.build_between_predicate('metric_ratio', min_ratio, max_ratio) }}
