{% test null_ratio_between(model, column_name, min_ratio, max_ratio, group_by=None, where=None) %}
...
select
    ...
    'null_ratio_between' as failed_check,
    'Null ratio must be between {{ min_ratio }} and {{ max_ratio }}' as failure_reason,
